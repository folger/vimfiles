...
@reg add "HKEY_CLASSES_ROOT\*\shell\Open with Vim"         /t REG_SZ /v "" /d "Open with V&im"   /f
...
@reg add "HKEY_CLASSES_ROOT\Folder\shell\Open with Vim"         /t REG_SZ /v "" /d "Open with V&im"   /f
